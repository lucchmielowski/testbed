...
WORKDIR /go/src/github.com/lucchmielowski/testbed
COPY . /go/src/github.com/lucchmielowski/testbed
RUN make

FROM scratch
COPY --from=build /go/src/github.com/lucchmielowski/testbed/* /bin/